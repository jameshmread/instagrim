 ...
 */
@WebFilter(filterName = "ProtectPages", urlPatterns = {"/upload.jsp", "/profile", "/profile/*", "/browse"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE})
