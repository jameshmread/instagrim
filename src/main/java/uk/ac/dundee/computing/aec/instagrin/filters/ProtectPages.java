 ...
 */
@WebFilter(filterName = "ProtectPages", urlPatterns = {"/upload.jsp", "/profile", "/profile/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.INCLUDE})
